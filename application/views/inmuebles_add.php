            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="form" method="post" action="<?php echo base_url('/index.php/inmuebles/add');?>">
                            <div class="form-group m-t-40 row">
                                <label for="nombre" class="col-2 col-form-label">Nombre del Inmueble</label>
                                <div class="col-10">
                                    <input class="form-control" type="text" value="" name="nombre" required data-validation-required-message="Nombre de inmueble inválido.">
                                </div>
                            </div>
                            ...
                            <div class="form-group row validate">
                                ...
                                <div class="input-group">
                                    <input type="number" min="0" value="" name="precio" class="form-control" required data-validation-required-message="Campo requerido. Verifica que está correcto el valor." aria-invalid="false"> 
                                </div>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                <div class="input-group">                                    
                                    <input class="form-control" value="" name="descripcion" required data-validation-required-message="Descripción de inmueble inválido."></input>
                                </div>
                                </div>
                            </div>             
